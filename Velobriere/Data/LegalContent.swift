...
/// fournie par le client ; ils restent à confirmer.
enum LegalContent {

    static let all: [LegalDocument] = [mentionsLegales, confidentialite, conditionsLocation]

    // MARK: - Mentions légales

    static let mentionsLegales = LegalDocument(
        id: "mentions-legales",
        ...
        sections: [
            ...
            .init(
                ...
                body: """
                Dans cette version de l'application, les demandes de réservation sont enregistrées uniquement sur l'appareil de l'utilisateur. Aucune donnée n'est transmise à un serveur distant.
    ...
    static let confidentialite = LegalDocument(
        id: "confidentialite",
        ...
        sections: [
            ...
            .init(
                ...
                La base légale est l'exécution de mesures précontractuelles et du contrat de location, au sens de l'article 6.1.b du RGPD. Aucun consentement distinct n'est requis pour ces données, qui sont nécessaires à la réservation.
                """
            ),
            .init(
                id: "stockage",
                ...
                body: """
                Dans cette version, vos données restent enregistrées localement sur votre appareil et ne sont transmises à aucun serveur. Désinstaller l'application les efface.
            ...
            .init(
                ...
                Vous pouvez également supprimer directement une demande de réservation depuis l'onglet « Réservations » de l'application.
            ...
            .init(
                ...
                heading: "Sécurité",
                body: """
                Vos données bénéficient des protections offertes par le système d'exploitation de votre appareil.
    ...
    // MARK: - Conditions générales de location

    static let conditionsLocation = LegalDocument(
        id: "cgl",
        ...
        sections: [
            ...
            .init(
                ...
                Modalités de paiement : [À COMPLÉTER : moment du paiement et moyens acceptés.]
                """
            ),
            .init(
                id: "garantie",
                heading: "4. Dépôt de garantie",
                body: """
            ...
            .init(
                id: "usage",
                heading: "5. Conditions d'utilisation",
                body: """
            ...
            .init(
                id: "responsabilite",
                heading: "6. Responsabilité, vol et détérioration",
                body: """
                ...
                [À COMPLÉTER : conditions de facturation en cas de casse ou de détérioration, et grille de refacturation le cas échéant.]
                """
            ),
            .init(
                id: "assurance",
            ...
            .init(
                ...
                body: """
                Le traitement des données personnelles est décrit dans la politique de confidentialité, accessible depuis cette même rubrique de l'application.
                """
            ),
            .init(
                id: "litiges",
                heading: "11. Réclamations et litiges",
                body: """
